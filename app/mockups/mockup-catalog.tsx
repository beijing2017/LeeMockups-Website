...
function ProductCard({ product }: { product: Product }) {
  ...
  return <article className="mockup-card">
    ...
    <div className="mockup-card-body"><div className="mockup-specs"><strong>$9.9</strong><span>2000 × 2000</span><span>10 sec</span></div><div className="mockup-card-actions">{isAvailable ? <><a className="mockup-buy-button" href={product.etsyUrl} target="_blank" rel="noreferrer">Buy on Etsy</a><a href="/order-download/">Already purchased? Download →</a></> : <button className="mockup-buy-button unavailable" type="button" disabled>Coming Soon</button>}</div></div>
  </article>;
}
