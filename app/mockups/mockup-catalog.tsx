...
function ProductCard({ product, purchased }: { product: Product; purchased: boolean }) {
  ...
  const available = commerce.available || product.purchaseProvider?.toUpperCase() === "CREEM" || product.sku === "LM-VM-MUG-001";
