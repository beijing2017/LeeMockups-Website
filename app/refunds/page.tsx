...
export default function RefundsPage() {
  return <main className="legal-page"><SiteNav /><article className="legal-shell shell">
    ...
    <section><h2>1. 30-day refund request window</h2><p>You may submit a refund request within 30 days of the transaction date. Requests are reviewed individually and a refund is not automatic after a digital product has been delivered, downloaded, or used. Refunds may be appropriate where a product cannot be delivered, is materially different from its description, is defective, or cannot be used on a supported system after reasonable troubleshooting.</p></section>
    ...
    <section><h2>3. How to request a refund</h2><p>For purchases processed by Paddle, submit the request through <a href="https://paddle.net" target="_blank" rel="noreferrer">paddle.net</a> and provide the email address used at checkout and your transaction details. For product troubleshooting or supporting information, use the feedback icon in the lower-right corner of this website.</p></section>
